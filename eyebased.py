...
window.title("Eye Based Passeord")
...
message = tk.Label(window, text="Eye Based Password Authentication SystemFace recognition" ,bg="Green"  ,fg="white"  ,width=50  ,height=3,font=('times', 30, 'italic bold underline')) 
...
lbl3 = tk.Label(window, text="Authentication : ",width=20  ,fg="red"  ,bg="yellow"  ,height=2 ,font=('times', 15, ' bold  underline')) 
...
trainImg = tk.Button(window, text="Train Images", fg="red",command=TrainImages  ,bg="yellow"  ,width=10  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
...
copyWrite.insert("insert", "Developed by Eswar","", "TEAM", "superscript")
