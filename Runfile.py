...
message3 = tk.Label(
    window,
    text="Face Recognition Based Attendance System With Emotion Detection",
    bg="green",
    fg="white",
    width=50,
    height=3,
...
txt = tk.Entry(
    window, width=20, bg="whitesmoke", fg="black", font=("times", 18, " bold ")
)
    ...
    while True:
        ...
        if int(aa) % 2 == 0:
            ...
            if status == 1:
                ...
                Hour, Minute, Second = timeStamp.split(":")
                fileName = (
                    "Attendance/Attendance_" + date + "_" + Hour + "-" + Minute + ".csv"
                )
                fileName1 = (
                    "Attendance/Absent_" + date + "_" + Hour + "-" + Minute + ".txt"
                )
                import os
